...
-->
    <div
        x-show="menu"
        class="absolute bottom-full flex flex-col rounded-md bg-white shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800"
        style="display: none"
        @click="menu = false"
    >
        <button
